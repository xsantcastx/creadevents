...
export class SeasonalPageComponent implements OnInit {
  ...
  seasonalData: { [key in Season]: SeasonalContent } = {
    ...
    summer: {
      ...
      heroImage: '/assets/ig_18_44253247569932.jpg',
    ...
    autumn: {
      ...
      heroImage: '/assets/ig_1794579_87187429_.jpg',
    ...
    winter: {
      ...
      heroImage: '/assets/WhatsApp%2_Image%2_2_24-12-19%2_at%2_13.18.18_f31e159.jpg',
